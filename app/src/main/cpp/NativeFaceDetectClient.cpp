...
//直播相关的代码，JIN部分
#ifdef ENABLE_FACE_DETECT_JNI_ONLOAD
...
Java_com_example_myapplication_face_FaceTrack_native_1create(JNIEnv *env,
...
Java_com_example_myapplication_face_FaceTrack_native_1start(JNIEnv *env, jobject instance,
                                                            jlong self) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_myapplication_face_FaceTrack_native_1stop(JNIEnv *env, jobject instance,
                                                           jlong self) {
...
Java_com_example_myapplication_face_FaceTrack_native_1detector(JNIEnv *env, jobject instance,
                                                               jlong self,
    ...
    int ret = rects.size();
    if (ret) {
        jclass clazz = env->FindClass("com/example/myapplication/face/Face");
