...
void *prepareFFmpeg_(void *args) {
    TigerFFmpeg *dnfFmpeg = static_cast<TigerFFmpeg *>(args);
...
TigerFFmpeg::TigerFFmpeg(CallJavaHelper *javaCallHelper, const char *dataSource)
...
void TigerFFmpeg::setRenderCallback(RenderFrame renderFrame) {
